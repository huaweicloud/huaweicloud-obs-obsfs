...
#ifndef S3FS_INDEX_CACHE_H_
#define S3FS_INDEX_CACHE_H_
#include "common.h"
#include "snas_list.h"
#include <assert.h>
#include <time.h>
...
//get cache_size
size_t IndexCache::GetCacheSize(void) const
{
    return size;
}

//set new cache_size, return old cache_size
size_t IndexCache::SetCacheSize(size_t cachesize)
{
